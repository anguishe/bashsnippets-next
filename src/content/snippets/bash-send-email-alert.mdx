...
<Callout type="info" title="Email is one delivery channel">

The APIs guide covers the other one most teams actually watch: a Slack incoming webhook posted with curl, with the same dedup idea so a flapping check does not page every minute. Full guide: [Shell Scripts That Talk to APIs](/guides/shell-scripts-that-talk-to-apis).
