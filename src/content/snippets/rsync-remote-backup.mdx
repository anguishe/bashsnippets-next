...
<Callout type="info" title="The offsite half of a backup">

The sysadmin guide puts this after the local backup script and before the retention cleanup, and explains why `--delete` on the wrong side is the mistake people only make once. Full guide: [25 Bash Scripts Every Linux Sysadmin Needs](/guides/bash-scripts-every-sysadmin-needs).
