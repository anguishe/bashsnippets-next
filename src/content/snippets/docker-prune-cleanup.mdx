...
<Callout type="info" title="Docker is one of five disk eaters">

The sysadmin guide covers the other four — logs, old backups, package caches and orphaned kernels — with the same dry-run-first pattern this script uses. Full guide: [25 Bash Scripts Every Linux Sysadmin Needs](/guides/bash-scripts-every-sysadmin-needs).
