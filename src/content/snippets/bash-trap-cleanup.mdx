...
When the script needs several working files, don't juggle several traps — make one temp directory and remove it whole (the [bashlib starter](/snippets/bashlib-starter) wraps this as `make_temp_dir`, cleaned up on every exit path):
