...
<p className="text-sm text-muted">Part of the <a href="/snippets/server-monitoring" className="text-blue hover:text-green transition-colors">Server Monitoring</a> · <a href="/snippets/disk-management" className="text-blue hover:text-green transition-colors">Disk Management</a> collection</p>
