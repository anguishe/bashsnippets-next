...
<Callout type="info" title="Finding the file is step one">

The sysadmin guide pairs this with the disk-space warning that should have fired first and the log-cleanup script that stops the same file from growing back. Full guide: [25 Bash Scripts Every Linux Sysadmin Needs](/guides/bash-scripts-every-sysadmin-needs).
