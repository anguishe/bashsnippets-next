...
<Callout type="info" title="Validate arguments at the top, loudly">

The safe-template guide shows the `: "${1:?usage: ...}"` form that fails with a sentence you wrote, and the header that makes an unexpected argument a stop instead of a silent default. Full guide: [The Safe Bash Script Template](/guides/safe-bash-script-template).
