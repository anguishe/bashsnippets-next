---
title: "find -perm 777 Missed a World-Writable File in My Test Tree. -perm -o+w Didn't."
published: true
description: "Exact-mode -perm misses a file at 666, chmod -R 644 walls off every directory it touches, and ssh ignores a private key at 644. Three runs on a scratch tree, the find audit that catches what other users can write, and the two-pass chmod that doesn't lock you out."
