# For Months My Dev Server Came Up on 3001. Tonight I Found Out Who Had 3000.
...
Originally published at https://bashsnippets.xyz/guides/open-ports-linux

<!-- Medium tags to set in the UI: Bash, Linux, Security, Sysadmin, Docker -->
