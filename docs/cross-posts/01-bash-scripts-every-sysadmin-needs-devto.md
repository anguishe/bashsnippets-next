---
title: "My Disk Check Prints WARNING at 88%. Cron Throws It Away Every Monday."
published: true
description: "A disk-space check on my own machine crosses its threshold and prints a warning that cron discards, because no mail agent is installed. The one-line check done so a human sees it, and the 24 other cron-ready bash checks it belongs with."
