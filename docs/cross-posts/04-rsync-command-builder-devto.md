---
title: "I Pointed rsync --delete at a Nearly Empty Directory. It Deleted 3,800 Files and Exited 0."
published: true
description: "A scratch rebuild of the classic mirror accident: rsync -a --delete from a source holding one file emptied a 3,800-file destination and exited 0. What rsync's exit code promises, why --dry-run without -v shows nothing, and a builder that makes --delete hard to misuse."
