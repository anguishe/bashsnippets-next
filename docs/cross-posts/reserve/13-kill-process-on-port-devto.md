---
title: "I Killed the Parent Process. Its Child Kept the Port."
published: true
description: "Killing the process you started doesn't free the port when a child owns the socket. A real run where the parent died and python kept 8098 — ask the socket table, then SIGTERM before SIGKILL."
