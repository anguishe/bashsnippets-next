---
title: "rsync projects and rsync projects/ Make Two Different Backups"
published: true
description: "A backup on the same disk shares every failure the original has. rsync over SSH fixes that — if the trailing slash, --delete, and a password prompt cron can't answer don't break it first."
