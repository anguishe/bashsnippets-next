...
> **ARCHIVED 2026-09-01 — every item here is resolved** (§1, §2, §4, §5 done; §3 killed). The
> living status board is `docs/PLAN.md`; the human steps are in `docs/MANUAL-ACTIONS-2026-09-01.md`.
