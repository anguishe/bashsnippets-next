...
| 3.G | Distribution capacity | ✅ **2026-09-20** — posts 02–14 created as dev.to drafts via `scripts/devto-drafts.mjs` (13 drafts, ids `4700404`–`4700422`, titles/tags/canonicals/covers set, bodies verified clean). dev.to's API cannot schedule, its editor can → Travis schedules all 13 in one sitting, so the Tue/Thu cadence survives WoW launch. #01 confirmed live 9/16 and ticked | `MANUAL-ACTIONS-2026-09-20.txt` §1 |
